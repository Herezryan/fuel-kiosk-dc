...
<body>
<!---This version was implemented 3-1-2024 to eliminate entering the ending totalizer. It just uses math to add starting totalizer and qtyfuel.--->											
		...
		<cfform name="form" action="#cgi.SCRIPT_NAME#?form.page=3" method="post">
			...
			<table style="width: 575px; font-size:20px;">
				...
				<tr>	
					...
					<td><cfinput type="text" name="pid_info" value="" style="width: 100%;" required="yes" message="* PID Info: Please enter personally identifiable information (i.e. Name, initials, etc)." maxlength="50"/></td>
					</tr>					
				<tr>	
